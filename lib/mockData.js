...
export const MOCK_SEASONS = [
    { id: 's1', name: 'Mùa giải 2025', startDate: '2025-01-01', endDate: '2025-12-31', isCurrent: false },
    { id: 's2', name: 'Mùa giải 2026', startDate: '2026-01-01', endDate: '2026-12-31', isCurrent: true },
];
...
export const MOCK_MATCHES = [
    { id: 'm1', seasonId: 's2', opponent: 'Sấm Sét FC', date: '2026-03-08T15:00', location: 'Sân Mỹ Đình', uniformId: 'u1', status: 'upcoming' },
    { id: 'm2', seasonId: 's2', opponent: 'Bão Lửa United', date: '2026-03-15T17:30', location: 'Sân Thống Nhất', uniformId: 'u2', status: 'upcoming' },
    { id: 'm3', seasonId: 's2', opponent: 'Hổ Vằn FC', date: '2026-02-22T15:00', location: 'Sân Mỹ Đình', uniformId: 'u1', status: 'completed' },
    { id: 'm4', seasonId: 's2', opponent: 'Rồng Xanh SC', date: '2026-02-15T16:00', location: 'Sân Hàng Đẫy', uniformId: 'u2', status: 'completed' },
    { id: 'm5', seasonId: 's2', opponent: 'Phượng Hoàng FC', date: '2026-02-08T15:00', location: 'Sân Mỹ Đình', uniformId: 'u1', status: 'completed' },
    { id: 'm6', seasonId: 's2', opponent: 'Kỳ Lân Stars', date: '2026-02-01T14:00', location: 'Sân Chi Lăng', uniformId: 'u3', status: 'completed' },
    { id: 'm7', seasonId: 's1', opponent: 'Đại Bàng SC', date: '2025-12-25T15:30', location: 'Sân Mỹ Đình', uniformId: 'u1', status: 'completed' },
];
